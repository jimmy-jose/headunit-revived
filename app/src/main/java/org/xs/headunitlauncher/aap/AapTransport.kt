...
import org.xs.headunitlauncher.aap.protocol.messages.KeyCodeEvent
import org.xs.headunitlauncher.aap.protocol.messages.MediaAck
import org.xs.headunitlauncher.aap.protocol.messages.Messages
import org.xs.headunitlauncher.aap.protocol.messages.NightModeEvent
import org.xs.headunitlauncher.aap.protocol.messages.ScrollWheelEvent
...
import org.xs.headunitlauncher.aap.protocol.proto.Control
...
class AapTransport(
    ...
    val isWireless: Boolean
        get() = connection is org.xs.headunitlauncher.connection.SocketAccessoryConnection
    ...
    internal fun startHandshake(connection: AccessoryConnection): Boolean {
        ...
        sendHandler?.post { org.xs.headunitlauncher.utils.LegacyOptimizer.setHighPriority() }
        ...
        pollHandler?.post { org.xs.headunitlauncher.utils.LegacyOptimizer.setHighPriority() }
