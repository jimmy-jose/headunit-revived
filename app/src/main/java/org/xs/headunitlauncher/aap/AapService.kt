...
import org.xs.headunitlauncher.utils.HotspotManager
import org.xs.headunitlauncher.utils.VpnControl
import org.xs.headunitlauncher.utils.SilentAudioPlayer
import org.xs.headunitlauncher.connection.CarKeyReceiver
...
import org.xs.headunitlauncher.utils.protoUint32ToLong
...
class AapService : Service(), UsbReceiver.Listener {
    ...
    private fun createNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, App.defaultChannel)
            ...
            .setOngoing(true)
            .setContentTitle("HeadUnitLauncher")
    ...
    companion object {
        ...
        const val ACTION_START_WIRELESS            = "org.xs.headunitlauncher.ACTION_START_WIRELESS"
        const val ACTION_START_WIRELESS_SCAN       = "org.xs.headunitlauncher.ACTION_START_WIRELESS_SCAN"
        const val ACTION_STOP_WIRELESS             = "org.xs.headunitlauncher.ACTION_STOP_WIRELESS"
        const val ACTION_NATIVE_AA_POKE            = "org.xs.headunitlauncher.ACTION_NATIVE_AA_POKE"
        ...
        const val ACTION_ORIENTATION_CHANGED     = "org.xs.headunitlauncher.ACTION_ORIENTATION_CHANGED"
        /**
         ...
         */
        const val ACTION_CONNECT_SOCKET            = "org.xs.headunitlauncher.ACTION_CONNECT_SOCKET"
