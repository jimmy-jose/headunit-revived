...
import org.xs.headunitlauncher.aap.protocol.proto.Wireless
    ...
    private suspend fun handleHandshake(socket: BluetoothSocket) = withContext(Dispatchers.IO) {
        try {
            ...
            if (settings.autoStartBluetoothDeviceMac != device.address) {
                ...
                org.xs.headunitlauncher.utils.Settings.syncAutoStartBtMacToDeviceStorage(context, device.address)
            }
