...
class KeymapFragment : Fragment(), MainActivity.KeyListener {
    ...
    private val keyCodeReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (intent.action == "org.xs.headunitlauncher.DEBUG_KEY") {
                val action = (intent.getStringExtra("action") ?: "unknown").replace("org.xs.headunitlauncher.", "")
    ...
    override fun onResume() {
        ...
        filter.addAction("org.xs.headunitlauncher.DEBUG_KEY")
