...
class HomeFragment : Fragment() {
    ...
    private var androidSettingsButton: Button? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        androidSettingsButton = view.findViewById(R.id.android_settings_button)
    ...
    private fun updateTextColors() {
        ...
        androidSettingsButton?.setTextColor(Color.WHITE)
    }
    ...
    private fun updateLauncherUi() {
        ...
        exitButton.text = if (isDefaultLauncher) {
