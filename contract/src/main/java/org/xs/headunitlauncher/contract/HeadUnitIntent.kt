package org.xs.headunitlauncher.contract
...
object HeadUnit {
    const val packageName = "org.xs.headunitlauncher"
}
...
/**
 * Broadcast sent when HeadUnitLauncher receives navigation updates from Android Auto
