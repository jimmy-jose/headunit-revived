...
import org.xs.hulhelper.TransparentTriggerActivity
import org.xs.hulhelper.connection.AapProxy
...
abstract class BaseStrategy(protected val context: Context, private val scope: CoroutineScope) : ConnectionStrategy {
    ...
    companion object {
        const val ACTION_TRIGGER_INTENT = "org.xs.hulhelper.ACTION_TRIGGER_INTENT"
    }
